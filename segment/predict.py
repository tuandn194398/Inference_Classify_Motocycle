            ...
            if len(det):
                ...
                for j, (*xyxy, conf, cls) in enumerate(reversed(det[:, :6])):
                    ...
                    if save_crop:
                        ...
                        path_bbseg = save_dir / 'train' / 'white' / names[c] / f'{p.stem}.jpg'
...
def parse_opt():
    ...
    parser.add_argument('--checkpoint', '-cp', type=str, default='', help='The path to the checkpoint file to run model predict')
